...
def enrich_plan_items(
    ...
    *,
    ...
    for item in items:
        ...
        item["required_text"] = text_policy.get("required_text") or []
        item["suggested_text"] = text_policy.get("suggested_text") or []
...
def build_plan_payload(
    *,
    ...
    return {
        ...
        "hero_template": effective_controls.get("hero_template", ""),
        "ending_module_type": effective_controls.get("ending_module_type", ""),
        "source_block_style": effective_controls.get("source_block_style", ""),
