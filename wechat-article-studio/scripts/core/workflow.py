...
def build_parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--openai-model", default="gpt-image-2")
    ...
    viral_run.add_argument("--openai-model", default="gpt-image-2")
    ...
    hosted_run.add_argument("--openai-model", default="gpt-image-2")
